...
11. Re-score unresolved legacy rows (`Can_duyet`, `Khong_the_cham`, `REVIEW_*`, pending and technical states) with the current pipeline; only legacy auto-final rows may be reused during migration.
